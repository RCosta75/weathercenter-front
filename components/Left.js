  ...
  return (
    <div className="w-1/5 bg-[#000A14] border-r-2 h-full flex-col flex border-stone-200 justify-center ">
      <div className="flex flex-col items-center justify-center py-5 gap-5">
        <h1 className="text-stone-100 font-serif text-3xl font-bold text-center">
          Save a City
        </h1>
        ...
        <div className="w-3/4 border-2 border-stone-100 rounded-lg">
          ...
          <div class="relative">
            ...
            <input
              ...
              type="search"
              id="search"
              class="block w-full p-4 ps-10 text-sm text-gray-900 border-2 border-stone-100 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"
              placeholder="Search"
              required
            />
            <button
              ...
              type="submit"
              class="text-white absolute end-2.5 bottom-2.5 bg-[#bfdbf7] focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 "
            >
              Search
            </button>
          </div>
        ...
        >
          <p
            ...
            className=" text-center font-serif text-xl text-red-700"
          >
            Please <span className="cursor-pointer underline">Login</span> To
            Save a City
          </p>
        </Modal>
      </div>
